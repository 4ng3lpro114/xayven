...
export type DeleteClientErrorCode = "protected" | "not_found" | "unauthorized" | "generic";
...
export async function requestDeleteClient(
  ...
  if (res.status === 409) return { status: "error", code: "protected" };
      ...
      <div className="flex items-start gap-2.5 rounded-lg border border-success/40 bg-success/10 px-4 py-3 text-sm">
        ...
        <div>
          ...
          <p className="mt-1 text-fg-muted">
            Este cliente tiene actividad comercial asociada y no puede eliminarse desde aquí.
          </p>
        </div>
      </div>
    );
