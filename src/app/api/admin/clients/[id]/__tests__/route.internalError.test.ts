...
/**
 * Isolated in its own file (same reasoning as the sibling conversation
 * delete tests): mocking deleteClient() to throw a generic failure would
...
describe("DELETE .../clients/[id] — error interno no controlado", () => {
